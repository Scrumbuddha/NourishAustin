...
export const metadata: Metadata = {
  title: "NourishAustin — healthy food, low cost",
  description:
    "Find healthy food near you in Austin — markets, pantries, and groceries that take SNAP/EBT — plus cheaper, healthier swaps for what you already buy.",
};
    ...
    <html lang="en" suppressHydrationWarning>
      <body className="min-h-screen antialiased">
        ...
        <footer className="mx-auto max-w-4xl px-4 py-8 text-xs text-stone-500">
          ...
          medical advice. A project to help Austin residents find affordable,
          healthy food.
        </footer>
      </body>
    </html>
