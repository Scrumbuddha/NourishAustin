    ...
    <div className="space-y-8">
      <section className="rounded-2xl bg-green-50 p-6 sm:p-10">
        ...
        <p className="mt-3 max-w-2xl text-lg text-green-950/80">
          Find healthy food near you in Austin — including free pantries and
          markets that <strong>accept SNAP/EBT</strong> — and learn simple swaps
          that save money and cut sugar and salt.
        </p>
      ...
      <section className="rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-900">
        <strong>Did you know?</strong> SNAP/EBT benefits go further at farmers
        markets and community pantries in Austin. Many accept double-value
        vouchers and direct EBT payments.
      </section>
    </div>
  );
}
