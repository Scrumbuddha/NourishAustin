...
const SYSTEM_PROMPT = `You are the NourishAustin Food Coach, helping people in Austin, Texas eat well on a tight budget.

Your job: help users find healthy food nearby (including free pantries and places that take SNAP/EBT or WIC), suggest cheaper-and-healthier swaps for foods they already buy, and plan affordable meals.
...
const tools: Anthropic.Tool[] = [
  {
    name: "search_places",
    description:
      "Search places to get food in Austin. Call this whenever the user asks where to buy or get food, or mentions SNAP/EBT, WIC, food pantries, or free food.",
    input_schema: {
      type: "object",
      properties: {
        benefit: {
          ...
          description:
            "Filter: snap = accepts SNAP/EBT, wic = accepts WIC, fab = double-value vouchers, free = free food. Omit for all places.",
        },
        place_type: {
          type: "string",
          enum: [
